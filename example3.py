...
contrast to pool_map, the results don't come in in order, however we see a
slight speed up as the two processes don't have to block each other (if the
second one finishes before the first)
"""
import numpy as np
import os
